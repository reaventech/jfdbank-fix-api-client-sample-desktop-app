...
import de.jfdbank.initiator.OrderTIF;
...
public class OrderEntryPanel extends JPanel implements Observer {
    ...
    private boolean currencyEntered = false;
    ...
    private JTextField securityIDTextField = new JTextField();
    private JTextField securityIDSourceTextField = new JTextField();
    private DoubleNumberTextField quantityTextField =
        new DoubleNumberTextField();
    private JTextField currencyTextField = new JTextField();
    private JTextField exDestinationTextField = new JTextField();
    private JTextField exDestinationIDSourceTextField = new JTextField();
    ...
    public OrderEntryPanel(final OrderTableModel orderTableModel,
        ...
        securityIDTextField.addKeyListener(activator);
        securityIDSourceTextField.addKeyListener(activator);
        quantityTextField.addKeyListener(activator);
        currencyTextField.addKeyListener(activator);
        exDestinationTextField.addKeyListener(activator);
        exDestinationIDSourceTextField.addKeyListener(activator);
    ...
    private void createComponents() {
        ...
        add(new JLabel("SecID"), ++x, y );
        add(new JLabel("SecIDSrc"), ++x, y );
        add(new JLabel("Qty"), ++x, y );
        add(new JLabel("Cur"), ++x, y );
        add(new JLabel("ExDes"), ++x, y );
        add(new JLabel("ExDesIDS"), ++x, y );
        ...
        securityIDTextField.setName("SecurityIDTextField");
        add(securityIDTextField, ++x, y);
        
        securityIDSourceTextField.setName("SecurityIDSourceTextField");
        add(securityIDSourceTextField, ++x, y);
        
        quantityTextField.setName("QuantityTextField");
        add(quantityTextField, ++x, y);
        
        currencyTextField.setName("CurrencyTextField");
        add(currencyTextField, ++x, y);
        
        exDestinationTextField.setName("exDestinationTextField");
        add(exDestinationTextField, ++x, y);
        
        exDestinationIDSourceTextField.setName("exDestinationIDSourceTextField");
        add(exDestinationIDSourceTextField, ++x, y);
    ...
    private class SubmitListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if (symbolTextField.getText() != null && !symbolTextField.getText().isBlank()) {
                order.setSymbolString(symbolTextField.getText().trim());
            }
            if (securityIDTextField.getText() != null && !securityIDTextField.getText().isBlank()) {
                order.setSecurityIDString(securityIDTextField.getText().trim());
            }
            if (securityIDSourceTextField.getText() != null && !securityIDSourceTextField.getText().isBlank()) {
                order.setSecurityIDSourceString(securityIDSourceTextField.getText().trim());
            }
            order.setQuantity(Double.parseDouble(quantityTextField.getText()));
            order.setCurrency(currencyTextField.getText());
            if (exDestinationTextField.getText() != null && !exDestinationTextField.getText().isBlank()) {
                order.setExDestinationString(exDestinationTextField.getText().trim());
            }
            if (exDestinationIDSourceTextField.getText() != null && !exDestinationIDSourceTextField.getText().isBlank()) {
                order.setExDestinationIDSourceString(exDestinationIDSourceTextField.getText().charAt(0));
            }
            ...
            application.sendNewOrderSingleRequest(order);
        }
    }
    ...
    private class SubmitActivator
        ...
        public void keyReleased(KeyEvent e) {
            ...
            } else if(obj == currencyTextField) {
                currencyEntered = testField(obj);
