...
import de.jfdbank.initiator.fix.MessageHandlerFix43;

public class SampleMessageHandlerFix43Impl implements MessageHandlerFix43 {
    private final InitiatorDemoDesktopApplication application;
    
    public SampleMessageHandlerFix43Impl(InitiatorDemoDesktopApplication application) {
    ...
    /**
     * OrderCancelReject handling for FIX.4.3 message
     * @param message
     * @param sessionID
     ...
     */
    public void onMessage( quickfix.fix43.OrderCancelReject message, 
            SessionID sessionID )
    ...
    /**
     * ExecutionReport handling for FIX.4.3 message
     * @param message
     * @param sessionID
     * @throws FieldNotFound
     * @throws UnsupportedMessageType
     * @throws IncorrectTagValue
     */
    public void onMessage( quickfix.fix43.ExecutionReport message, 
            SessionID sessionID )
    	throws FieldNotFound, UnsupportedMessageType, IncorrectTagValue {
    ...
    /**
     * BusinessMessageReject handling for FIX.4.3 message
     * @param message
     * @param sessionID
     * @throws FieldNotFound
     * @throws UnsupportedMessageType
     ...
     */
    @Override
    public void onMessage( quickfix.fix43.BusinessMessageReject message,
            SessionID sessionID )
    	throws FieldNotFound, UnsupportedMessageType, IncorrectTagValue {
