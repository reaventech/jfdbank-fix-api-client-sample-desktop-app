 ...
 */
package de.jfdbank.initiator.fix.jfd;
...
public class JFDTradeMessageHandlerFix43Impl implements MessageHandlerFix43 {

    private final InitiatorDemoDesktopApplication application;
    
    public JFDTradeMessageHandlerFix43Impl(InitiatorDemoDesktopApplication application) {
